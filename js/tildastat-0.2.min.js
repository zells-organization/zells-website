...
if(p>=89){if(isSendScrollEvent.p90==0){tildaParams.page='/tilda/scroll/90/';w.tildastat('pageview');isSendScrollEvent.p90=w.setTimeout(function(){w.clearTimeout(isSendScrollEvent.p90);isSendScrollEvent.p90=-1},5000);return}else{if(isSendScrollEvent.p90==-1){isSendScrollEvent.p90=0;return}}}}};w.tildastat=function(event,params){var staturl='https:'+'https://stat'+'.tildacdn.'+'com/event/';if(!event){return!1}
